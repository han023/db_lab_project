      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            toplables(lablelist: ['coast','subtotal','tax','discount']),

            Expanded(
              child: FutureBuilder(
                  future: databasehelper.openDatabaseAndPerformQueries('SELECT * FROM billing'),
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      snapshot.data[index]['cost_charger'].toString(),
                                      style:
