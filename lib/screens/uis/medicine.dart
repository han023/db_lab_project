      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            toplables(lablelist: ['name','expiry','ingredients','']),

            Expanded(
              child: FutureBuilder(
                  future: databasehelper.openDatabaseAndPerformQueries('SELECT * FROM medicine'),
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      snapshot.data[index]['medicine_name'],
                                      style:
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: const EdgeInsets.only(
                                          left: 5.0),
                                      child: Text(snapshot
                                          .data[index]['medicine_expiry_date'],
                                        style:
                                  ...
                                  Expanded(
                                    child: Text(
                                      snapshot.data[index]['medicine_ingredients'],
                                      style:
                                      TextStyle(fontFamily: 'small',
                                          fontSize: AppLayout.getwidth(context) *
                                              0.03),),
