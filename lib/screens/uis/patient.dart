      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            toplables(lablelist: ['name','age','city','address']),

            Expanded(
              child: FutureBuilder(
                  future: databasehelper.openDatabaseAndPerformQueries('SELECT * FROM patient'),
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      snapshot.data[index]['patient_address'],
                                      style:
                                      TextStyle(fontFamily: 'small',
                                          fontSize: AppLayout.getwidth(context) *
                                              0.03),),
