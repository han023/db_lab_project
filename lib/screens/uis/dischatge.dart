      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            toplables(lablelist: ['Treatment','date','','']),

            Expanded(
              child: FutureBuilder(
                  future: databasehelper.openDatabaseAndPerformQueries('SELECT * FROM discharge'),
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      snapshot.data[index]['date_of_discharge'],
                                      style:
