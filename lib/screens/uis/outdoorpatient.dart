...
class outdoor_patient extends StatelessWidget {
  const outdoor_patient({super.key});
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            top(title: 'Outdoor Patient'),

            const searchview(),

            toplables(lablelist: ['date','reason','','']),

            Expanded(
              child: FutureBuilder(
                  future: databasehelper.openDatabaseAndPerformQueries('SELECT * FROM outdoor_patient'),
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      snapshot.data[index]['date_of_visit'].toString(),
                                      style:
                                  ...
                                  Expanded(
                                    child: Text(
                                      snapshot.data[index]['reason_for_visiting'].toString(),
                                      style:
