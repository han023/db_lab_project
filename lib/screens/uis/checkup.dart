      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            toplables(lablelist: ['type','date','result','']),

            Expanded(
              child: FutureBuilder(
                  future: databasehelper.openDatabaseAndPerformQueries('SELECT * FROM checkup'),
                            ...
                            return Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      snapshot.data[index]['checkup_type'],
                                      style:
                                  ...
                                  Expanded(
                                    child: Padding(
                                      padding: const EdgeInsets.only(
                                          left: 5.0),
                                      child: Text(snapshot
                                          .data[index]['checkup_date'].toString(),
                                        style:
                                  ...
                                  Expanded(
                                    child: Text(
                                      snapshot.data[index]['checkup_results'].toString(),
                                      style:
                                      TextStyle(fontFamily: 'small',
                                          fontSize: AppLayout.getwidth(context) *
                                              0.03),),
